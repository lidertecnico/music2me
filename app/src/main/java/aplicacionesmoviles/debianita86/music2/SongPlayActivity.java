...
public class SongPlayActivity extends AppCompatActivity {
    ...
    private void loadSongs() {
        ...
        // Reproduce la canción seleccionada cuando el usuario hace clic en una
        listViewSongs.setOnItemClickListener((parent, view, position, id) -> {
            currentSongIndex = position; // Actualiza el índice de la canción seleccionada
            playSong(songPaths.get(currentSongIndex)); // Reproduce la canción
        });
    }
    ...
    private void playSong(String songUriString) {
        ...
        // Libera el MediaPlayer si ya estaba en uso
        if (mediaPlayer != null) {
            mediaPlayer.reset();
            mediaPlayer.release();
            mediaPlayer = null;
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(mp -> {
                ...
                btnPlay.setImageResource(R.drawable.ic_pause); // Cambia el botón a "pausa"
                isPlaying = true;
                updateProgressBar(); // Actualiza la barra de progreso de la canción
            });

            mediaPlayer.setOnCompletionListener(mp -> {
                // Si la canción termina, reproduce la siguiente o muestra un mensaje si es la última
